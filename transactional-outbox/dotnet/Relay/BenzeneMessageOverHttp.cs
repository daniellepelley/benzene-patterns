...
/// of the example. <b>Three independent patterns in this repo have now needed it</b> — the
/// real-time-risk map-reduce coordinator and the modular-monolith extraction carry the same ~50
/// lines — which is the strongest argument for closing it upstream and deleting all three copies.
/// </para>
/// <para>

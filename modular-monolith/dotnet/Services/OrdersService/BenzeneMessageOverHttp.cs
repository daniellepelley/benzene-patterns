...
/// of the example. <b>Two independent patterns in this repo have now needed it</b> — the
/// real-time-risk map-reduce coordinator carries the same ~50 lines — which is the strongest
/// argument for closing it upstream and deleting both copies.
/// </para>
/// <para>
